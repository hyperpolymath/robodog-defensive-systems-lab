...
// Replace robodog-ecm, Robodog Ecm — See README.adoc for details., just run, Robodog Ecm started successfully. with actuals
= robodog-ecm — Quick Start for Users
:toc:
:toclevels: 2

== What is robodog-ecm?

Robodog Ecm — See README.adoc for details.
...
[source]
----
Robodog Ecm started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/robodog-ecm/wiki
