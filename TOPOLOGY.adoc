...
communications resilience, secure coordination, and autonomy-safety
research. It is not a deployment architecture for fielded RF,
surveillance, weapon, or restricted-end-user systems.
