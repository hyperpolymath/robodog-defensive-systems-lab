...
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/robodog-ecm"]
...
| API | **zig** | Consumer-facing API surface
|===
...
- [x] zig API (full type mirror, classification, recommendations)
