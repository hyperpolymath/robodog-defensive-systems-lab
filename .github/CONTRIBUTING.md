...
# Contributing — robodog-ecm

## Audience

Developers working **on** `robodog-ecm`. For consumers (people calling
or depending on it) see <a href="./usage.adoc" class="adoc">usage</a>.
...
``` bash
git clone git@github.com:hyperpolymath/robodog-ecm.git
cd robodog-ecm
...
- Bugs in `robodog-ecm`: file at `hyperpolymath/robodog-ecm/issues`.
